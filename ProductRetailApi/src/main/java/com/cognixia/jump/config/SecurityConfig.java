...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
            ...
            .antMatchers(HttpMethod.DELETE, "/api/order/delete/*").hasRole("ADMIN")  //delete order by id
            .antMatchers(HttpMethod.POST, "/api/book/add").hasRole("ADMIN") // add new book 
            .antMatchers(HttpMethod.DELETE, "/api/book/delete").hasRole("ADMIN") // add new book 
